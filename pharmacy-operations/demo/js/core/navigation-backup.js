  ...
  groups: [
    ...
    },
    {
      ...
      items: [
        ...
        { route: "batch-stock", label: "Batch Stock", icon: "🧪" },
    ...
    },
    {
      ...
      items: [
        ...
        { route: "gst-report", label: "GST & Tax Report", icon: "🧮" },
        { route: "gstr1", label: "GSTR-1", icon: "🧾" },
        { route: "gstr3b", label: "GSTR-3B Working", icon: "📔" },
       { route: "input-gst", label: "Input GST / ITC", icon: "🧾" },
        { route: "accountant-gst", label: "Accountant GST Reports", icon: "📃" },
        { route: "gst-control-center", label: "GST Control Center", icon: "📀" },
        { route: "stock-report", label: "Stock Report", icon: "📋" },
    ...
    },
    {
      ...
      items: [
        ...
        { route: "pharmacy-profile", label: "Pharmacy Profile", icon: "🏪" },
